...
#define BIND_ACTION_ACT        343  //RETURN
...
//actions, alts
#define BIND_ACTION_QUIT        BIND_NO_KEY
#define BIND_ACTION_ACT         ' '
#define BIND_ACTION_EXIT_POPUP  BIND_NO_KEY
#define BIND_ACTION_INPUT_MODE  BIND_NO_KEY
#define BIND_ACTION_EXIT_INPUT  BIND_NO_KEY
